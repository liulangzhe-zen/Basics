package com.basics.common.imgloader.transform;
...
/**
 * @CreateDate: 2020-03-23 16:42
 * @Version: 1.0
 * @Description:  Glide 圆角Transform，默认CenterCrop剪裁方式
 * @Author: xueshijie
 */
public class RoundedCornersTransformation extends CenterCrop {
    ...
    protected Bitmap transform(@NonNull BitmapPool pool,
        ...
        Bitmap tranform = super.transform(pool, toTransform, outWidth, outHeight);
        int width = tranform.getWidth();
        int height = tranform.getHeight();
